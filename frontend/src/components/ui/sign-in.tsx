...
export const TestimonialCard = ({ testimonial, delay }: { testimonial: Testimonial, delay: string }) => (
  <div className={`animate-testimonial ${delay} flex items-start gap-3 rounded-3xl bg-card/40 dark:bg-zinc-800/40 backdrop-blur-xl border border-white/10 p-5 w-72`}>
    ...
    <div className="text-sm leading-snug">
      ...
      <div className="flex flex-col mb-1.5">
        <p className="text-muted-foreground text-[10px] uppercase tracking-wider font-bold mb-0.5">{testimonial.role || 'Usuario Verificado'}</p>
        <p className="text-foreground/90 text-xs leading-relaxed">{testimonial.text}</p>
      </div>
    </div>
  </div>
);
